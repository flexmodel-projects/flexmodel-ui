...
const GroovyIdPForm: React.FC<Props> = ({ readOnly = false }) => {
  ...
  return (
    <>
      ...
      <Form.Item name="script" label={t('idp_groovy')} tooltip={t('idp_groovy_tooltip') || undefined} rules={[{ required: true }]}>
