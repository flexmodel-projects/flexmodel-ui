...
import {Button, Checkbox, Col, Form, Input, message, Modal, Row, Select, Tabs, Tooltip,} from 'antd';
import {
  CaretDownOutlined,
  CaretRightOutlined,
  EditOutlined,
...
import {debounce, SCHEMA_TYPE} from './utils.js';
...
import LocalProvider from './components/LocalProvider/index.jsx';
